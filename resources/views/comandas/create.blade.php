...
<head>
    ...
    <title>ServiceLink - Crear Comanda</title>
</head>
...
<body>
    ...
    <div class="container">
        ...
        <!-- Main Content -->
        <main>
            <h1>Crear Nueva Comanda</h1>

            <div style="background: white; padding: 20px; border-radius: 8px; max-width: 600px;">
                @include('Comandas._form', ['action' => route('comandas.store'), 'method' => 'POST', 'empleados' => $empleados, 'mesas' => $mesas])
            </div>
        </main>
        <!-- End of Main Content -->
